...
class UpdateProfile extends Component {
  ...
  updateProfile = () => {
      ...
      axios
        .patch(`http://localhost:5000/users/update/${userId}`, {fname: this.state.fname, lname: this.state.lname, imageUrl: this.props.imageurl})
        .then((res) => {
          console.log(res)
        })
       ...
       setTimeout( () => {
       	const allDetails = document.querySelectorAll('.profileDetails');
                ...
                document.querySelector('#userNameBanner').innerHTML = `<h3>
                 ...
                 document.querySelector('#userNameBanner2').innerHTML = `${this.state.fname} ${this.state.lname}`;
     });
       ...
       setTimeout( () => {
       	const allDetails = document.querySelectorAll('.profileDetails');
                ...
                document.querySelector('#userNameBanner').innerHTML = `<h3>
                 ...
                 document.querySelector('.profileImageRounded').setAttribute("src", this.state.imageURL);
  ...
  render = () => {
    return (
        <Form className="test hide" id="edit_form">
         <Form.Group>
    <Form.File id="exampleFormControlFile2" label="Choose a profile picture" onChange={this.setImage}/>
